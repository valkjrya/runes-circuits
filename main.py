...
SEGNI = {
    "TERRA": ["Toro", "Vergine", "Capricorno" "Gemelli", "Bilancia", "Acquario" "Ariete", "Leone", "Sagittario"],
    "SPAZIO": ,
}

RUNE_PER_ELEMENTO = {
    "TERRA": ["Fehu", "Uruz", "Berkano", "Jera" "Laguz", "Perthro", "Eihwaz", "Isa" "Kenaz", "Sowilo", "Tiwaz", "Hagalaz" "Algiz", "Dagaz", "Nauthiz", "Othila"],
}
...
RUNE_VARIANTS_IT = {
    ...
    # ... (ho messo solo le prime 5 per brevità – copia da qui in giù e aggiungi le altre come prima, o dimmi se vuoi che te le espanda tutte)
    "Perthro": ["Il mistero non va risolto: va attraversato.", "Oggi il destino gioca a carte coperte.", "Accetta l'ignoto: è il tuo alleato.", "La runa nasconde, ma non mente.", "Un velo si alza piano, guarda." "Rimani nel passaggio: la trasformazione è in atto.", "Oggi sei tra due mondi: resta fermo.", "Il ponte è fragile, ma regge.", "Cambiamento non è fine: è mezzo.", "Respira nel vuoto: lì nasce il nuovo." "Fermati. Nel silenzio trovi chiarezza.", "Oggi il gelo ti protegge.", "Non muoverti: ascolta il vuoto.", "La pausa è potere.", "Il ghiaccio riflette la verità." "Ascolta il messaggio: sta già parlando.", "Oggi la parola arriva dal vento.", "La tua bocca sa cosa dire.", "Un respiro e la verità esce.", "Il divino sussurra: tendi l'orecchio." "Il viaggio è iniziato: muoviti con intenzione.", "Oggi un passo cambia tutto.", "La strada è tua: scegli.", "Non correre: cammina consapevole.", "Il movimento è preghiera." "Dare e ricevere sono lo stesso gesto.", "Oggi un regalo torna indietro.", "L'equilibrio è nel tuo cuore.", "Non contare: scambia.", "La connessione è reciproca."],
    "Wunjo": ["La gioia arriva quando smetti di cercarla.", "Oggi il sorriso è già dentro.", "Sii felice senza motivo.", "La luce è tua, accoglila.", "La gioia non si insegue: si respira." "Una scintilla illumina ciò che era nascosto.", "Oggi vedi chiaro.", "Il fuoco interiore si accende.", "La torcia è nella tua mano.", "Non temere l'ombra: accendila."],
    "Sowilo": ["La luce è dalla tua parte. Avanza.", "Oggi il sole ti segue.", "Non nasconderti: splendi.", "La vittoria è già tua.", "Il giorno è lungo: usalo." "Accendi il coraggio: una scelta ti libera.", "Oggi decidi e vola.", "La spada è la tua volontà.", "Non dubitare: agisci.", "Il giusto è già dentro." "Il cambiamento rompe ciò che non serve più.", "Oggi il vecchio crolla.", "La grandine pulisce.", "Lascia che cada: rinasci.", "Il caos è ordine nascosto." "Sei protetta mentre resti fedele a te.", "Oggi il tuo scudo è vivo.", "Non temere: sei guardata.", "La protezione è dentro.", "Resta vera: niente ti tocca." "Una nuova visione si apre ora.", "Oggi l'alba è dentro.", "Il buio finisce.", "Vedi oltre.", "La luce cambia tutto." "La necessità rivela la via.", "Oggi il bisogno ti guida.", "Non c'è scelta: c'è destino.", "Il fuoco della fame illumina.", "Sopravvivi: cresci." "Riconosci ciò che ti appartiene davvero.", "Oggi la casa è dentro.", "Il tuo sangue parla.", "Torna alla radice.", "Ciò che è tuo non si perde."]
}
...
<div style="display:flex;align-items:center;gap:14px;">
  ...
  <div id="runa-name" style="font-size:36px;font-weight:bold;">{e(data )}</div>
</div>
<div id="msg-it" style="margin-top:16px;font-size:20px;">{e(data )}</div>
<div id="msg-en" style="opacity:.7;margin-top:6px;">{e(data )}</div>
<a href="#" id="cta" style="display:inline-block;margin-top:28px;padding:16px 28px;border-radius:999px;background:#ffd27a;color:#1a1206;font-weight:900;text-decoration:none;">{CTA_TEXT}</a>
</div>
<script>
(function(){{
  ...
  btn.onclick = async function(e){{
    ...
    const res = await fetch("/oracle?elemento="+encodeURIComponent("{e(data )}")+"&nonce="+Date.now());
